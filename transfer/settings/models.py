...
class Setting(models.Model):
	...
	org_name = models.CharField(blank=True, null=True, max_length=20, verbose_name='Название организации',)

	top_img = models.ImageField(upload_to='setting', blank=True, null=True, verbose_name='Изображение в верхнем разделе',)
	favicon = models.ImageField(upload_to='setting', blank=True, null=True, verbose_name='favicon',)
	logo_top = models.ImageField(upload_to='setting', blank=True, null=True, verbose_name='Логотип в шапке',)
...
class SocialNetwork(models.Model):
	name = models.CharField(max_length=512, choices=SOCIAL_NETWORK_CHOICES, verbose_name='Название соц. сети',)
...
class TelegramChenalID(models.Model):
	tele_bot = models.ForeignKey(TelegramBot, on_delete=models.CASCADE, related_name='chat')
...
class TelegramChatID(models.Model):
	tele_bot = models.ForeignKey(TelegramBot, on_delete=models.CASCADE, related_name='chenal')
