...
from .models import (About, Setting, SocialNetwork, TelegramBot,
                     TelegramChatID, TelegramChenalID)
...
class SettingAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        urls = super().get_urls()
        custom_urls = [path('', self.admin_site.admin_view(
